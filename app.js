...
var users = {
   liz: {errores: 1, aciertos: 4, pass: '123'},
   stefy: {errores: 1, aciertos: 10, pass: '123'}
};
...
//console.log(req);
  ...
  if(users[name]){
      ...
      if(req.body.pass){
          users[name].pass = req.body.pass;
      }
  } else {
      users[name] = {errores: req.body.errores, aciertos: req.body.aciertos, pass: req.body.pass};
  }
